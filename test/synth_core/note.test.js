...
describe("Note", () => {
  it("returns correct object when constructed with valid argument values", () => {
  ...
  it("raises an error if constructed with an invalid argument value", () => {
    // Name
  ...
  it("handles enharmonic equivalents properly", () => {
  ...
  it("handles notes at start/end of valid range properly", () => {
