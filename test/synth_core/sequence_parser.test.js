...
describe("SequenceParser", function() {
  test("should properly parse a valid sequence", function() {
  ...
  test("should properly parse a sequence containing ties", function() {
  ...
  test("should properly parse a sequence with bad note names", function() {
  ...
  test("should properly parse a sequence containing trailing spaces", function() {
    var rawSequence = ["A4", "-", "-", "-", "", "", ""];
    var parsedSequence = SequenceParser.parse(rawSequence);
  ...
  test("should properly parse a sequence with unattached sustain characters ('-')", function() {
  ...
  test("should properly parse a sequence with leading sustain characters ('-')", function() {
    var rawSequence = ["-", "-", "-", "-"];
    var parsedSequence = SequenceParser.parse(rawSequence);
