...
describe("SequenceParser", () => {
  it("properly parses a valid sequence", () => {
  ...
  it("properly parses a sequence containing ties", () => {
  ...
  it("properly parses a sequence with invalid note names", () => {
  ...
  it("properly parses a sequence containing trailing spaces", () => {
    var rawSequence = ["A4", "-", "-", "-", "", "", ""];
    var parsedSequence = SequenceParser.parse(rawSequence);
  ...
  it("properly parses a sequence with unattached sustain characters ('-')", () => {
  ...
  it("properly parses a sequence with leading sustain characters ('-')", () => {
    var rawSequence = ["-", "-", "-", "-"];
    var parsedSequence = SequenceParser.parse(rawSequence);
