...
class PatternRowRemoveButton extends React.PureComponent {
  ...
  render() {
    return <button className="button-standard button-standard-small full-width round" onClick={this.removePatternRow}>X</button>;
  };
};
...
class PatternFooter extends React.PureComponent {
  ...
  render() {
    return <div className="flex flex-justify-space-between">
      <button className="button-standard button-standard-full" onClick={this.addPatternRow}>Add Row</button>
      <span>
        <button className="inline-block button-standard button-standard-full mr-half" disabled={this.props.selectedRowIndex === undefined || this.props.selectedStepIndex === undefined} onMouseDown={this.eraseNote}>&#8998;</button>
        <button className="inline-block button-standard button-standard-full" disabled={this.props.selectedRowIndex === undefined || this.props.selectedStepIndex === undefined} onMouseDown={this.setNoteAsDash}>—</button>
      </span>
    </div>;
  };
};
