...
class Controls extends React.PureComponent {
  ...
  render() {
    return <span className="whitespace-wrap-none">
      ...
      <button className={"mr-half mr1-l button-tab-list button-hollow" + (this.props.isPlaying ? " button-toggled" : "")}  onClick={this.props.onTogglePlayback}><span className={"play-icon" + (this.props.isPlaying ? " play-icon-enabled" : "")}>Play</span></button>
    </span>;
  };
};
